...
import { X, Download, Star, Users, ArrowLeft, ExternalLink, Image, Sparkles, BookOpen, MessageSquare, User, FileText } from 'lucide-react';
...
/** Renders a labeled text block if content exists. */
          ...
          <div className={styles.tabContent}>
            ...
            {activeTab === 'prompts' && (
              <div className={styles.promptsGrid}>
                {isChub ? (
                  <p className={styles.emptyText}>Install this character to view full prompt data. Only the description is available from the Chub API.</p>
                ) : (
                  <>
                    ...
                    <TextBlock label="Post-History Instructions (Author's Note)" content={lumiData?.post_history_instructions} />
            ...
            {activeTab === 'creator' && (
              <div className={styles.creatorInfo}>
                <TextBlock label="Creator Notes" content={lumiData?.creator_notes || (isChub ? 'Not available from Chub API.' : null)} />
                ...
                {lumiData?.creation_date && (
                  <div className={styles.metaRow}>
                    <span className={styles.metaLabel}>Originally Created</span>
